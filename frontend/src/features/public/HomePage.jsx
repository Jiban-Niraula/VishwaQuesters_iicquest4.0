			...
			<div className="vc-landing">
				<section className="vc-hero">
					<div className="vc-hero-content">
						...
						<p>
							A professional live production platform for creators to
							connect cameras, manage overlays, stream to RTMP platforms,
							and earn from sponsored ad placements.
						</p>
				...
				<section id="features" className="vc-section">
					<div className="vc-section-head">
						...
						<p>
							Vision Cast keeps production tools organized so creators
							can focus on the live event, not the complexity behind it.
						</p>
					</div>
				...
				<section className="vc-split-section">
					<div>
						...
						<h2>
							Creators stream. Companies promote. Admin controls the
							platform.
						</h2>
					</div>
					...
					<div className="vc-split-grid">
						<article>
							...
							<h3>Creators</h3>
							<p>
								Create events, connect cameras, run the studio, play
								sponsored ads, and receive wallet earnings.
							</p>
						</article>
						...
						<article>
							...
							<h3>Companies</h3>
							<p>
								Upload campaigns, set play limits, pay from wallet, and
								get approved ads shown inside creator streams.
							</p>
						</article>
						...
						<article>
							...
							<h3>Admin</h3>
							<p>
								Manage pricing, commissions, approvals, users, wallet
								actions, and platform-level settings.
							</p>
						</article>
					</div>
				</section>
				...
				<section className="vc-section">
					<div className="vc-section-head center">
						...
						<p>
							Start with the free plan, then buy Pro directly when you
							need unlimited cameras and full creator tools.
						</p>
					</div>
					...
					<div className="vc-plan-grid">
						<article className="vc-plan-card">
							<h3>Free</h3>
							<p>
								For creators starting with simple multi-camera streams.
							</p>
						...
						<article className="vc-plan-card featured">
							<h3>Pro</h3>
							<p>
								For creators who need unlimited cameras and own ad
								uploads.
							</p>
				...
				<section className="vc-faq-section">
					...
					<div className="vc-faq-list">
						<details>
							...
							<p>
								Yes. Creators can share the event camera link or session
								code and use phones as remote camera angles.
							</p>
						</details>
						...
						<details>
							...
							<p>
								Yes. Approved company ads appear in the creator
								marketplace, and earnings are credited after completed
								ad placements.
							</p>
						</details>
						...
						<details>
							...
							<p>
								Yes. Vision Cast supports RTMP destinations including
								YouTube, Facebook, Twitch, and custom RTMP servers.
							</p>
						</details>

						<details>
							<summary>
								Can I buy Pro without depositing to wallet?
							</summary>
							<p>
								Yes. Pro can be purchased directly through the
								subscription page. Wallet deposit is optional and mainly
								used for ad campaigns, payouts, and wallet-based
								actions.
							</p>
						</details>
					</div>
				...
				<section className="vc-final-cta">
					...
					<p>
						Create your account, set up your first event, and bring your
						live production into one organized studio.
					</p>
