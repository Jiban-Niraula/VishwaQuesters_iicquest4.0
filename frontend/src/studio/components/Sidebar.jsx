...
import { LAYOUTS, PLATFORM_OPTIONS, OVERLAY_TYPES, OVERLAY_POSITIONS } from '../utils/constants';

export default function Sidebar({ eventCode, actions }) {
  const {
    cameras, activeCameraId, activeLayout, mutedCameras, activeAudioSource,
    commentaryActive, commentaryMuted, overlays, activeOverlays, newOverlay,
    newOverlayMedia, newOverlayVideoUrl, scorecardData, destinations, newDest,
    eventData, activePanel, sponsoredAds, currentSponsoredAd, sponsoredAdLoading
  } = useStudio();

  const {
    setActivePanel, setActiveCameraId, changeLayout, handleCreateOverlay,
    setNewOverlay, setNewOverlayMedia, setNewOverlayVideoUrl, toggleOverlayActive,
    handleDeleteOverlay, toggleCommentaryMute, stopCommentary, startCommentary,
    setScorecardData, handleScorecardUpdate, handleCompleteSponsoredAd,
    handlePlaySponsoredAd, setNewDest, handleAddDestination, toggleDestinationActive,
    handleDeleteDestination, resolveMediaUrl, playSponsoredAd
  } = actions;
