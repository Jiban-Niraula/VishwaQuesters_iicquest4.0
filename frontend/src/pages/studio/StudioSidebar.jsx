								...
								<div className="space-y-2">
									...
									{(newOverlayVideoUrl.includes("youtube.com") ||
										...
										<div className="text-xs bg-amber-500/10 text-amber-300 p-3 rounded border border-amber-500/30 leading-relaxed">
											...
											and use the <b>Share Screen</b> button at the
											top of the studio to bring it into your
											broadcast!
										</div>
									)}
								</div>
						...
						{currentSponsoredAd && (
							<div className="bg-green-900/40 border border-green-700 rounded-lg p-3 space-y-2">
								...
								<p className="text-xs text-green-100 leading-relaxed">
									Complete after playback. Payout will be calculated
									from verified Vision Cast platform viewers.
								</p>
								...
								<div className="grid grid-cols-2 gap-2 text-xs">
									<div className="bg-black/20 rounded p-2">
										...
										<strong className="text-green-100">
											NRS{" "}
											{Number(
												currentSponsoredAd.estimatedPayoutPerView ||
													0,
											).toFixed(2)}
										</strong>
									</div>
										...
										<div className="flex items-start justify-between gap-2">
											<div>
												...
												<p className="text-xs text-gray-500">
													Budget left: NRS{" "}
													{Number(ad.remainingBudget || 0).toFixed(
														2,
													)}{" "}
													• CPV: NRS{" "}
													{Number(
